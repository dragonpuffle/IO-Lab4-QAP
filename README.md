...
Чуть выше уже было сказано, что в процентном соотношении результаты не сильно отличаются, однако в абсолютных значениях изменение около 100000. Нужно учитывать также, что с большим количеством вершин, труднее улучшить результат, так как вариантов больше. Также важно учитывать, что local search следует запускать несколько раз (например среди 20 запусков бенчмарок может попасться отличный или средний результат), чтобы получить лучший результат, а iterated local search (из-за своей итеративности) стабильно приводит к отличным результатам.
